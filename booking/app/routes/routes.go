...
func (_ tApplication) TestFunc(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("Application.TestFunc", args).Url
}
...
func (_ tHotels) TestFunc(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("Hotels.TestFunc", args).Url
}
